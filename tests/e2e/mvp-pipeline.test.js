...
`;
        ...
        writeFileSync(join(flowtraceDir, 'processes/test-mvp-process.json'), JSON.stringify({ processId: 'test-mvp-process', name: 'Test MVP Process' }));
...
`;
    ...
    describe('场景 A: 等价流程 (legacy-shadow)', () => {
        beforeEach(() => {
            ...
            writeFileSync(join(flowtraceDir, 'scenarios/scenarios.json'), JSON.stringify({ processId: 'test-mvp-process', scenarios }, null, 2));
        });
    ...
    describe('场景 B: 案例数量一致性', () => {
        it('B1: generate/validate/verify 数量一致', () => {
            ...
            writeFileSync(scenariosFile, JSON.stringify({ processId: 'test-mvp-process', scenarios }, null, 2));
...
//# sourceMappingURL=mvp-pipeline.test.js.map