...
function seedConfig(root, options = {}) {
...
function seedProcessInventory(root) {
...
function seedScenarios(root, processId, scenarios) {
...
function seedRecording(root, processId, confirmed) {
    const flowtraceRoot = join(root, '.flowtrace');
    mkdirSync(flowtraceRoot, { recursive: true });
    if (!confirmed) {
...
//# sourceMappingURL=command-gate.test.js.map