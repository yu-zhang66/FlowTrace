 ...
 */
import { z } from 'zod';
import { BrowserStepSchema } from './browser.js';
...
// ============================================================
export function validateEnhancedScenario(data) {
