 ...
 * 断言登录结果与预期匹配
 */
export function assertLoginSuccess(observation) {
    return {
 ...
 * 断言登录失败与预期匹配
 */
export function assertLoginFailure(observation, expectedErrorType) {
 ...
 * 断言 semanticPath 匹配
 */
export function assertSemanticPath(observation, expectedSemanticPath) {
 ...
 * 断言 errorCode 匹配
 */
export function assertErrorCode(observation, expectedErrorCode) {
...
export function assertAgainstExpected(observation, expected) {
    if (!expected) {
 ...
 * 断言新旧系统登录状态一致性
 */
export function assertAuthStateConsistency(legacyObservation, currentObservation) {
 ...
 * 断言错误类型一致性
 */
export function assertErrorConsistency(legacyObservation, currentObservation) {
 ...
 * 从页面文本/错误提示推断错误类型
 */
export function inferErrorType(errorHint, pageTitle) {
...
//# sourceMappingURL=login-execution.js.map