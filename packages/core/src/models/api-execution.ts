...
export type ApiMappingRequestField = z.infer<typeof ApiMappingRequestFieldSchema>;
...
export type ApiMappingResponseField = z.infer<typeof ApiMappingResponseFieldSchema>;
...
export type ApiExecutionRequest = z.infer<typeof ApiExecutionRequestSchema>;
...
export type ApiExecutionResponse = z.infer<typeof ApiExecutionResponseSchema>;
...
export type ApiDifferenceType = z.infer<typeof ApiDifferenceType>;
...
export type ApiDifference = z.infer<typeof ApiDifferenceSchema>;
...
export type ApiComparisonResult = z.infer<typeof ApiComparisonResultSchema>;

// ============================================================
// API Execution Adapter Interface
// ============================================================

export interface ApiExecutionAdapter {
  initialize(config: {
    baseUrl?: string;
    auth?: {
  ...
  executeCall(request: ApiExecutionRequest): Promise<ApiCallResult>;
  
  normalizeResponse(result: ApiCallResult, mapping: ApiMapping): {
    success: boolean;
    businessState: string | null;
    extractedData: Record<string, unknown>;
  };
  
  captureNetworkCalls(): Promise<Array<{
    url: string;
    method: string;
    request: unknown;
    response: unknown;
...
export type DualApiStepResult = z.infer<typeof DualApiStepResultSchema>;
