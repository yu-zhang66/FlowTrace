...
import { loadTargetProjectConfig, resolveProcess, listProcessCandidates, createConfirmedState, writeRecordingState, } from '@flowtrace/core';
/** Set by recordConfirmCommand; available for programmatic callers after the command runs. */
export let lastRecordConfirmResult;
/**
 ...
 */
export async function recordConfirmCommand(options) {
...
function resolveProcessId(projectRoot, query) {
    if (query) {
...
function buildRemediation(error) {
    const remediation = [];
...
//# sourceMappingURL=record-confirm.js.map