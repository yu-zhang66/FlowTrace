...
import { resolveScenarios, findLoginScenarios, findScenarioById, checkScenarioSecurity, loadScenariosFromDir } from '../../cli/src/commands/test/scenario-resolver.js';
...
`);
            const scenarios = loadScenariosFromDir(testDir);
            expect(scenarios.length).toBe(1);
            expect(scenarios[0].id).toBe('nested-001');
        });
...
//# sourceMappingURL=scenario-resolver.test.js.map