...
describe('DifferenceClassifier', () => {
    ...
    describe('groupBySeverity', () => {
        it('should group differences by severity', () => {
            const differences = [
                { severity: 'P0', scenarioId: 's1', category: 'final_state', description: '', legacyValue: null, currentValue: null, id: 'd1', isBlocking: true },
                { severity: 'P0', scenarioId: 's2', category: 'final_state', description: '', legacyValue: null, currentValue: null, id: 'd2', isBlocking: true },
                { severity: 'P1', scenarioId: 's3', category: 'semantic_path', description: '', legacyValue: null, currentValue: null, id: 'd3', isBlocking: false }
            ];
