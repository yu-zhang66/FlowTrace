...
function generateFlowchart(id, title, nodes, titleNode) {
    const mermaidNodes = [];
    const mermaidEdges = [];
...
// ============================================================
function renderMermaidDiagrams(report) {
    return `
## 流程图对比
...
// ============================================================
function renderScenarioDetailPage(report) {
...
// Index Page
// ============================================================
function renderIndexPage(summary, scenarioIds) {
    return `<!DOCTYPE html>
<html lang="zh-CN">
<head>
  <meta charset="UTF-8">
...
export class EnhancedReportGenerator {
     ...
     */
    generate(scenarios, executionResults) {
     ...
     */
    generateScenarioReport(scenario, execution) {
     ...
     */
    generateSummary(scenarios, reports) {
 ...
 */
export function createEnhancedReportGenerator(config) {
    return new EnhancedReportGenerator(config);
}
//# sourceMappingURL=enhanced-business-report.js.map